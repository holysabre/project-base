        ...
        Route::group(['prefix' => 'productions'], function () {
            ...
            Route::group(['prefix' => '{production}'], function () {
                ...
                Route::group(['prefix' => 'production_media'], function () {
                    ...
                    Route::post('', [ProductionMediaController::class, 'store'])->name('production_media.store');
                    Route::group(['prefix' => '{production_media}'], function () {
                        Route::get('', [ProductionMediaController::class, 'show'])->name('production_media.show');
                        Route::delete('', [ProductionMediaController::class, 'destroy'])->name('production_media.destroy');
